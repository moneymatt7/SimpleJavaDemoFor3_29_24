package edu.fscj.JavaDemo.main;

import edu.fscj.JavaDemo.art.Letters.*;
import java.util.Scanner;

import static edu.fscj.JavaDemo.art.Letters.ASCII_CHAR_MAP;
    ...
    public static StringBuilder toAscii(String input) {
        ...
        for (int row = 0; row < LETTER_HEIGHT; row++) {
            ...
            for (char c : input.toCharArray()) {
                ...
                String[] asciiLetter = ASCII_CHAR_MAP.get(c);
